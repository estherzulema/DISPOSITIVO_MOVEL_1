...
import 'package:vidente_app_avaliacao/models/previsao_hora.dart';
import 'package:vidente_app_avaliacao/services/previsao_service.dart';
import 'package:vidente_app_avaliacao/widgets/proximas_temperaturas.dart';
import 'package:vidente_app_avaliacao/widgets/resumo.dart';
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                return Column(
                  children: [
                    Resumo(
                      cidade: InputController.instance.nC,
                ...
                Text('Erro ao carregar as previsões');
              }
